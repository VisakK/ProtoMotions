...
class SmplRobotConfig(RobotConfig):
    ...
    asset: RobotAssetConfig = field(
        default_factory=lambda: RobotAssetConfig(
            # Custom "boxhands / lowtorque" SMPL asset (repo-root data/assets).
            # kinematic_info (dof names + joint limits) is parsed from this MJCF at
            # __post_init__, so it MUST match the spawned USD. The USD is the full
            # MjcfConverter package generated by usd_convert/ (with its worldBody
            # articulation deactivated and bodies rooted under Robot/Pelvis/).
            asset_root="data/assets",
            asset_file_name="smpl/smpl_boxhands_lowtorque.xml",
            usd_asset_file_name="smpl/smpl_boxhands_lowtorque_usd/smpl_boxhands_lowtorque_flat.usda",
