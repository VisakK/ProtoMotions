...
from pair_contact_view import (  # noqa: E402
    GROUND_FILTER_PATH,
    GROUND_NAME,
    PairContactView,
    gather_pair_buffer as _gather_pair_buffer,
)
...
def check_single_motion(motion_file: str) -> str:
    ...
    * The motion manager samples ids from the subset at reset rather than
    ...
    (:mod:`record_pressure_rollout` lifts the second restriction by pinning the
    ids explicitly and asserting after the reset; the first still stands.)
    """
