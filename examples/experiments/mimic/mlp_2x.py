...
"""
Mimic Environment Configuration - 2x width
==========================================
...
Identical to ``mlp.py`` except the actor/critic trunks are twice as wide
(1024 -> 2048 units per layer; depth, learning rates and every env / reward
setting are unchanged). Motivated by
``notes/MultiMotion_expert_vs_SingleMotion_expert.MD``: a single-motion crow
expert masters a clip that the 14-pose expert oscillates on, pointing at model
capacity / multi-motion interference rather than PD-contact dynamics.

Parameter count: 10.53M (1024) -> 37.8M (2048).
"""
